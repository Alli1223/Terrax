...
enum class GameState   { MainMenu, SettingsMenu, JoinMenu, CharacterSelect, CharacterEditor, HouseEditor, Loading, Playing, Paused };
...
static constexpr int   MAX_LANTERNS      = 192;   // per-frame point lights (town lamps out to ~15 chunks)
